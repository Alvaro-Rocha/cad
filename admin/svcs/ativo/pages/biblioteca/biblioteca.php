...
<body>
    <h2 class="text-primary d-flex justify-content-center" ><b>Scripts</b></h2>
      <div class="container">
        <div class="row">  
              ...
              <div class="col-5" style="padding:0;">
                ...
                <div  style="display:flex"> 
                  <select multiple id='css' class="esqa form-control input-lg" size="6" style="height: 100%;">
                      <?php foreach ($page->getCSS() as $key => $value) { ?>
                        <?php if(!array_key_exists($key, $page->getCSSpage($id))) {?>
              ...
              <div class="col-5" style="padding:0;">        
                <select multiple id='selecaoCategoria' name='selecaoCategoria[]' class="dira form-control input-lg"  size="6" style="height: 100%;">
                      <?php foreach ($page->getCSSpage($id) as $key => $value) { ?>
        ...
        <div class="row">
              ...
              <div class="col-5" style="padding:0;">
                ...
                <div  style="display:flex">
                  <select multiple id='js' class="esqb form-control input-lg" size="6" style="height: 100%;">
                      <?php foreach ($page->getJS() as $key => $value) { ?>
                        <?php if(!array_key_exists($key, $page->getJSpage($id))) {?>
                          <option value="<?=$key?>"><?=$value['nome']?></option>
                        <?php } ?>
                      <?php } ?>
                  </select>     
              ...
              <div class="col-5" style="padding:0;">        
                <select multiple id='selecaoCategoria' name='selecaoCategoria[]' class="dirb form-control input-lg"  size="6" style="height: 100%;">
                      <?php foreach ($page->getPHPpage($id) as $key => $value) { ?>
                        <option id="valor<?=$key?>"><?=$value?></option>
                      <?php } ?>
                </select>
              </div> 
        ...
        <div class="row">  
              <label for="css" class="form-label">PHP</label>
              <div class="col-5" style="padding:0;">
                
                <div  style="display:flex">
                  <select multiple id='php' class="esqc form-control input-lg" size="6" style="height: 100%;">
                      <?php foreach ($page->getPHP() as $key => $value) { ?>
                        <?php if(!array_key_exists($key, $page->getJSpage($id))) {?>
                          <option value="<?=$value?>"><?=$value['nome']?></option>
                        <?php } ?>
                      <?php } ?>
                  </select>
                </div>
              ...
              <div class="col-2 mt-4">    
                <div style="display:flex; flex-direction:column ">
                  <i class="fa fa-3x fa-arrow-right dirc text-center" aria-hidden="true"></i>
                  <i class="fa fa-3x fa-arrow-left  esqc text-center" aria-hidden="true"></i>
                </div>
              </div>
              <div class="col-5" style="padding:0;">        
                <select multiple id='selecaoCategoria' name='selecaoCategoria[]' class="dirc form-control input-lg"  size="6" style="height: 100%;">
                      <?php foreach ($page->getJSpage($id) as $key => $value) { ?>
                        <option id="valor<?=$key?>"><?=$value?></option>
                      <?php } ?>
                </select>
              </div> 
...
<!-- ============================================================================== -->    
    ...
    <?php include_once('biblioteca_js.php'); ?>
    <!-- ================================================================= -->        
</body>
</html>